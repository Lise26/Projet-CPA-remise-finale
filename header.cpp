...
int header::info(ofstream &result, int *score) {						//displays the names of the protein with high scores in the results file
	
	result << "\n\n" << endl;
	result << "50 sequences producing the best alignements :                    Scores\n" << endl;
		for (int i = 0; i<50;i++){
