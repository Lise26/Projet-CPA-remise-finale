...
int main(int argc, char **argv) {
	...
	vector<char> proteinTab = prot.getProteinTable();
	...
	if(sequenceFile.is_open()) {
		algo.sequenceMatch(sequenceFile, seqOffset, sizeQueryProtein, proteinTab, sequenceSize, gapOpenPenalty, gapExtensionPenalty);
