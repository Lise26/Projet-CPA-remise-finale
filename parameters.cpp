...
int parameters::verifParameters(int argc, char **argv) {        
	...
	if(argc > 3) {
		...
		initOptionalParameters(argc, argv);
	}
	else {
		initParameters(argc, argv);
	}
...
int parameters::initOptionalParameters(int argc, char **argv) {
	nameMatrix = argv[3];
...
string parameters::getNameSequence() {
	return nameSequence;
}

string parameters::getNameIndex() {
	return nameIndex;
}

string parameters::getNameHeader() {
	return nameHeader;
}

string parameters::getNameMatrix() {
	return nameMatrix;
}

int parameters::getGapOpenPenalty() {
	return gapOpenPenalty;
}

int parameters::getGapExtensionPenalty() {
